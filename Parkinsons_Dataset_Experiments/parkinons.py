...
for noise_level in noise_levels:
    K_partial = compute_partial_kernel(X_scaled, tasks, noise_level, 0)
    ...
    if rank == 0:
        ...
        with open(f'park_kernel_matrix_noise_level_{noise_level}.pkl', 'wb') as f:
            pickle.dump(K, f)
...
if rank == 0:
    ...
    with open(f'park_centralized_kernel_matrix.pkl', 'wb') as f:
        pickle.dump(K, f)
